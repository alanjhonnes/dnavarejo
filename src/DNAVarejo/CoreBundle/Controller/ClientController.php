...
namespace DNAVarejo\CoreBundle\Controller;
...
use DNAVarejo\CoreBundle\Entity\Client;
use DNAVarejo\CoreBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DNAVarejoCoreBundle:Client')->findAll();
     ...
     * @Method("POST")
     * @Template("DNAVarejoCoreBundle:Client:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DNAVarejoCoreBundle:Client')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DNAVarejoCoreBundle:Client:edit.html.twig")
     */
